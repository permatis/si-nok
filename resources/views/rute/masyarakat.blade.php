...
<body>
    ...
    function initMap() {
        ...
        var point1 = new google.maps.LatLng(-7.090487, 110.366218);
        var point2 = new google.maps.LatLng(-7.086464, 110.361822);
        // var point3 = new google.maps.LatLng(-7.086985, 110.361098);
        var point3 = new google.maps.LatLng(-7.080396, 110.357859);
        var wps = [
          { location: point1 },
          { location: point2 },
          // { location: point3 },
        ...
        service.getDistanceMatrix({
            origins: [org],
            destinations: [point1, point2,  dest],
            travelMode: 'DRIVING',
            avoidHighways: false,
            avoidTolls: false,
        }, callback);
