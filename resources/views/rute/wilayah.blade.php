...
<body>
    ...
    function initMap() {
        ...
        var point1 = new google.maps.LatLng(-7.099077, 110.355335);
        var point2 = new google.maps.LatLng(-7.100532, 110.354226);
        // var point3 = new google.maps.LatLng(-7.101312, 110.358883);
        var point4 = new google.maps.LatLng(-7.103042, 110.360927);
        ...
        var dest = new google.maps.LatLng(-7.102553, 110.361766);
        ...
        service.getDistanceMatrix({
            origins: [org],
            destinations: [point1, point2, point4,  dest],
            travelMode: 'DRIVING',
            avoidHighways: false,
            avoidTolls: false,
        }, callback);
