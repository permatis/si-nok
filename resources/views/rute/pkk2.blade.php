...
<body>
    ...
    function initMap() {
        ...
        var point1 = new google.maps.LatLng(-7.088917, 110.361879);
        var point2 = new google.maps.LatLng(-7.090704, 110.358745);
        var point3 = new google.maps.LatLng(-7.099246, 110.355545);
        var wps = [
          { location: point1 },
          { location: point2 },
          { location: point3 }
        ...
        var dest = new google.maps.LatLng(-7.09972, 110.35584);
        ...
        service.getDistanceMatrix({
            origins: [org],
            destinations: [point1, point2, point3,  dest],
            travelMode: 'DRIVING',
            avoidHighways: false,
            avoidTolls: false,
        }, callback);
