       ...
       <div class="card-panel">
           <div class="row">
               <span class="card-title">
                ...
                <form class="col s12" action="{{ url('/ketik/kategori') }}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="row">
                   <div class="input-field col s12">
                      <input placeholder="Nama Kategori" name="nama" type="text">
                      <label for="nama">Nama Kategori</label>
                   </div>
                </div>
                <div class="row">
                   <div class="input-field col s12">
                      <input placeholder="Deskripsi" type="text" name="deskripsi">
