       ...
       <div class="card-panel">
           <div class="row">
               <span class="card-title">
                ...
                <form class="col s12" action="{{ url('/ketik/potensi') }}" method="post" enctype="multipart/form-data">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">

                <div class="row">
                    <div class="input-field col s12">
                        <select class="icons" name="kategori[]" multiple>
                ...
                <div class="row">
                    <div class="file-field input-field col s12">
                        ...
                        <div class="file-path-wrapper">
                            <input class="file-path" type="text" placeholder="Upload satu atau banyak gambar">
                        </div>
                    </div>
                </div>
                <div id="prev"></div>
                <div class="row">
                    <div class="input-field col s12">
                        ...
                        <a href="{{ url('ketik/potensi') }}" class="btn waves-effect waves-light blue">Kembali</a>
                    </div>
                </div>
                </form>
           </div>
